...
class PopoverFlujo03_Test {
   ...
   @BeforeAll
	...
	void test() {
		...
		$$("button").findBy(Condition.text("With tabs")).click();
		sleep(2000);
		...
		$$("button").findBy(Condition.text("With form")).click();
		sleep(2000);	
		...
		$$("button").findBy(Condition.text("With card")).click();
		sleep(2000);

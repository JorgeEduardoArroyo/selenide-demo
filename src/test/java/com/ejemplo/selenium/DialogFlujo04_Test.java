...
class DialogFlujo04_Test {
   ...
   @BeforeAll
	...
	void test() {
		...
		$$("button").findBy(Condition.text("Open Dialog with backdrop click")).click();
		sleep(2000);
		
		$$("button").findBy(Condition.text("Dismiss Dialog")).click();
		sleep(2000);
		
		$$("button").findBy(Condition.text("Open without backdrop click")).click();
		sleep(2000);
